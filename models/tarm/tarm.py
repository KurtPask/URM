...
class TARM(nn.Module):
    def __init__(self, config_dict: dict):
        super().__init__()
        self.config = TARMConfig(**config_dict)
        self.inner = TARM_Inner(self.config)
    ...
    ) -> Tuple[TARMCarry, Dict[str, torch.Tensor]]:
